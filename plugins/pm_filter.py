...
from database.connections_mdb import active_connection, all_connections, delete_connection, if_active, make_active, \
    make_inactive
from info import ADMINS, AUTH_CHANNEL, DELETE, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, P_TTI_SHOW_OFF, IMDB, \
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('<b><i>⚠ 404 Error / No Results❗ \n\n🚫 The Reason❓[<a href="https://telegram.me/MYFLiiX">Click Here</a>] \n📮 Please Follow Request Tips \n🔆 Request Tips › [<a href="https://telegram.me/MYFLiiX">Click Here</a>]</i></b>')
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('🔆彡[ MYFLiiX ]彡🔆')
            else:
    ...
    if query.data.startswith("file"):
        ...
        await query.answer('🔆彡[ MYFLiiX ]彡🔆')
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply('<b><i>⚠ 404 Error, No Results❗ \n\n🚫 The Reason❓[<a href="https://telegram.me/MYFLiiX">Click Here</a>] \n📮 Please Follow Request Tips \n🔆 Request Tips › [<a href="https://t.me/MYFLiiX">Click Here</a>]</i></b>')
        await asyncio.sleep(60)
        await k.delete()
        return
